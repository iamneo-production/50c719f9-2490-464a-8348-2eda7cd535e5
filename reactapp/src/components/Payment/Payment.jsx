                ...
                <div class="row">
                    <div class="col-md-7 col-lg-7 col-xl-6 mb-4 mb-md-0">
                        ...
                        <div>
                            ...
                            <div class="p-2 d-flex justify-content-between align-items-center" style={{backgroundColor: "#eee"}}>
                            ...
                            <Link class="btn btn-success btn-lg btn-block" to="/pay">Proceed to payment</Link>
                        </div>
                    </div>
                    <div class="col-md-5 col-lg-4 col-xl-4 offset-lg-1 offset-xl-2">
                        <div class="p-3" style={{backgroundColor: "#eee"}}>
                            ...
                            <hr />
                            <div class="d-flex justify-content-between mt-2">
                                <span>Total </span> <span class="text-success">${props.total}</span>
                            </div>
                        </div>
                    </div>
                </div>
